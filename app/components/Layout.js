...
export default function Layout({ children, title = "StealthList", description = "View and manage waitlist signups for StealthList." }) {
  return (
    <>
      <Head>
        <title>{title}</title>
          ...
          <div className="container mx-auto px-6 py-4">
            <div className="flex items-center justify-between">
              ...
              <nav className="hidden md:flex items-center gap-6">
                <a href="/dashboard" className="text-foreground font-medium">Production</a>
                <a href="/local-dashboard" className="text-muted-foreground hover:text-foreground transition-colors">Local</a>
